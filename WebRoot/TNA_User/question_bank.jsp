          ...
          <div class="hbox hbox-auto-xs hbox-auto-sm">
            <div class="col">
              <div style="background:url(img/c4.jpg) center center; background-size:cover">
               ...
               <table width="80%">
                <tr>
                 1、JDK 的构成中不包含以下哪个部分？（答案：C）
             <input type="button" value="修改"><input type="button" value="删除">  <br>
                A.JDK中 包含了JRE，JVM中包含了JRE<br>
                B.JDK中包含了JRE，JRE中包含了JVM<br>
               C.JRE中包含了JDK，JVM中包含了JRE<br>
                D,JRE中包含了JDK，JDK中包含了JVM<br>
               </tr>
               <tr>
                1、下列关于JDK、JVM、JRE的描述，哪项正确？（答案：B）
                  <input type="button" value="修改"><input type="button" value="删除"> <br> 
                A. Java编程语言<br>
               B. 工具及工具的API<br>
               C. Java EE扩展API<br>
